          ...
          <HStack h={"70%"}>
            <Stack spacing={4} w={"220px"}>
              ...
              <Text fontSize={"12px"} color={"brand.textgrey"}>
                We screen all submissions to identify high-potential candidates
              </Text>
            </Stack>
            <Divider
      ...
      >
        ...
        >
          ...
          <Text fontSize={"16px"}>
            ...
            those in-demand skills. At Zulfah, you'll get the work experience to
        ...
        <Flex p={8} flex={1} alignItems={"center"} justifyContent={"center"}>
          ...
          >
            ...
            <Text fontSize={"16px"} color={"#000000"}>
              ...
              to help you polish your portfolio, practice interviewing and more
              to land a job that fits your goals.
            </Text>
            <Button
              variant={"solid"}
              bg={"brand.fuscia"}
      ...
      >
        ...
        <Flex p={8} flex={1} alignItems={"center"} justifyContent={"center"}>
          ...
          >
            ...
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lirisus,
              dignissim netus nulla assa eu sed id. Sit aliquam volutpat auctor
              turpis. Sed lectus enim scelerisque maecenas enim eget sed. ue sed
              dignissim. Ultricies pretium nibh et quam. Rutrum facilisis lectus
              accumsan morbi nulla quis suscipit. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. Lirisus, dignissim netus nulla assa
              eu sed id. Sit aliquam volutpat auctor turpis. Sed lectus enim
              scelerisque m Lorem ipsum dolor sit amet, consectetur adipiscing
              elit. Lirisus, dignissim netus nulla assa eu sed id.
            </Text>
            <Button
              variant={"solid"}
              bg={"brand.fuscia"}
